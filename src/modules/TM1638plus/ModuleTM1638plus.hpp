...
enum SEVEN_SEGMENT_ANIMATION_TYPE
{
    ...
    SEVEN_SEGMENT_ANIMATION_TYPE_ALIEN_VOICE_5 = 12,
    SEVEN_SEGMENT_ANIMATION_TYPE_ALIEN_VOICE_6 = 13,
    SEVEN_SEGMENT_ANIMATION_TYPE_ALIEN_VOICE_7 = 14,
    SEVEN_SEGMENT_ANIMATION_TYPE_ALIEN_VOICE_8 = 15,
    SEVEN_SEGMENT_ANIMATION_TYPE_ALIEN_VOICE_9 = 16,
    SEVEN_SEGMENT_ANIMATION_TYPE_ALARM_REVERB = 17,
    SEVEN_SEGMENT_ANIMATION_TYPE_DIRTY_SYREN_1 = 18,
    SEVEN_SEGMENT_ANIMATION_TYPE_DIRTY_SYREN_2 = 19,
    SEVEN_SEGMENT_ANIMATION_TYPE_NOTES = 20,
    SEVEN_SEGMENT_ANIMATION_TYPE_WAVE = 21,
    SEVEN_SEGMENT_ANIMATION_TYPE_MESSAGE_1 = 22,
};
